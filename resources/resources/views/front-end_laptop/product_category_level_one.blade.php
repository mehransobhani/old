                ...
                <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
                    ...
                    <div class="block shop-by-side">
                        ...
                        <div class="filter_box">
                            ...
                            <div style="direction:ltr;padding-top:20px;padding-bottom:20px;">
                                                ...
                                                @foreach($child_item as $key2=>$value2)
                                                    ...
                                                    <li onclick="set_filter('<?= $value->id ?>','<?= $value2->id ?>','<?= $name ?>')">
                                                        @if($value->filed==1)
                                                            ...
                                                            @endphp
                                                            <input id="filter_checkbox_<?= $value2->id ?>"
                                                                   type="checkbox"
                            ...
                            @else
                                <div class="block-content">
                                    <div class="layered-Category">
                                        <h2 class="saider-bar-title">دسته ها</h2>
                                        <div class="layered-content">

                                            <ul class="check-box-list">
                                                @foreach($cat_list as $child)

                                                    <li>

                                                        <label for="jtv8"> <span class="button"></span>
                                                            <a href="{{ route('site.categoryLevelTwo',[$category1->cat_ename,$child->cat_ename])}}"> {{$child->cat_name}}</a>
                                                        </label>
