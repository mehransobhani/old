...
@section('content')
    ...
    <div class="form-group">
        {!! Form::label('product_id','انتخاب محصول : ') !!}
        {!! Form::select('product_id',$products,null,['class'=>'selectpicker','data-live-search'=>'true','data-size'=>10,'placeholder' => 'لطفا انتخاب کنید...']) !!}
        <br>
