    ...
    @if(sizeof($get_colors)>0)
        ...
        @foreach($get_colors as $key=>$value)
            ...
            <div class="form-group">
                ...
                <input type="text" label="قیمت" class="form-control" value="{{ $value->price }}" placeholder="قیمت" class="color_input_price" name="color_price[{{ $value->id }}]">
                
                <input type="text" label="موجودی" class="form-control" value="{{ $value->inventory }}" placeholder="موجودی" name="color_inventory[{{ $value->id }}]">
            </div>
...
add_color=function ()
{
    ...
    input4.name='color_inventory['+id+']';
