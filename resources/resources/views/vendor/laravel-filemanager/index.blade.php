...
<head>
  ...
  <link rel="stylesheet" href="{{asset('vendor/laravel-filemanager/vendor/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{asset('vendor/laravel-filemanager/vendor/all.css')}}">
  <link rel="stylesheet" href="{{asset('vendor/laravel-filemanager/vendor/jquery-ui.min.css')}}">
...
<body>
  ...
  <script src="{{asset('vendor/laravel-filemanager/vendor/jquery-3.2.1.min.js')}}"></script>
  <script src="{{asset('vendor/laravel-filemanager/vendor/popper.min.js')}}"></script>
  <script src="{{asset('vendor/laravel-filemanager/vendor/bootstrap.min.js')}}"></script>
  <script src="{{asset('vendor/laravel-filemanager/vendor/jquery-ui.min.js')}}"></script>
