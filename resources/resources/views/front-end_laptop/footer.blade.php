                ...
                <div class="footer-links">
                    ...
                    <div class="tabBlock" id="TabBlock-1">
                        <ul class="list-links list-unstyled">
                            ...
                            <li><a href="{{route('site.showPage',['شرایط-بازگرداندن-کالا'])}}">شرایط بازگرداندن سفارش</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="footer-links">
                    ...
                    <div class="tabBlock" id="TabBlock-3">
                        <ul class="list-links list-unstyled">
                            ...
                            <li><a href="{{route('site.showPage',['تجهیز-آشپزخانه-صنعتی'])}}">تجهیز آشپزخانه صنعتی</a></li>
                            <li><a href="{{route('site.showPage',['تولید-انواع-یخچال-فروشگاهی'])}}">تولید انواع یخچال فروشگاهی</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-2 col-xs-12 col-lg-3 collapsed-block">
                <div class="footer-links">
                    ...
                    <div class="tabBlock" id="TabBlock-4">
                        <ul class="list-links list-unstyled">
                            <li><a href="{{route('site.showPage',['فروش-محصولات-در-تجهیزلند'])}}">فروش محصولات در تجهیزلند</a></li>
