...
class Product extends Model
{
	...
	protected $fillable = ['title', 'code', 'title_url', 'code_url', 'price',
		...
		'order_product', 'keywords', 'description', 'special','delivery_time'];
	...
	{
		return $this->belongsToMany(Category::class, 'cat_product','product_id','cat_id');
	}
	...
	public static function search($data)
	{
		...
		if (sizeof($data) > 0)
		{
			...
			{
				$Category = $product->where('title', 'like', '%' . $data['title'] . '%');
