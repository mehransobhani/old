                    ...
                    @foreach($product_data as $key2=>$value2)
                        ...
                        @if($data)
                            <tr>
                                ...
                                <td class="cart_price">
                                    <p>
                                        <span class="p1">{{ number_format($data['color_price']) }}</span>
                                        <span class="p2">تومان</span>
                                    </p>
                                </td>
                                <td class="cart_price">
                                    <p>
                                        <span class="p1">{{ number_format($data['color_price']*$value2) }}</span>
                                        <span class="p2">تومان</span>
                                    </p>
                                </td>
                            ...
                            <?php
                            $total_price+=$data['color_price']*$value2;
                            $price+=$data['color_price']*$value2;
                            ?>
                            <?php $j++; ?>
                        @endif
