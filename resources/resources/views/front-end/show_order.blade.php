                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ul>
                            ...
                            <li><strong>مشاهده وضعیت سفارش</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
...
{{--                                                                <span class="p1">{{ number_format($product->price-$product->discounts) }}</span>--}}
                                                                <span class="p1">{{ number_format($value->unit_price) }}</span>
...
//						                                        $price=$value->number*($product->price-$product->discounts);
						                                        $price=$value->number*($value->unit_price);
						                                        ?>
