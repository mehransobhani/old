...
@section('content')
  <style>
        ...
        @media only screen and (max-width: 768px) {
            ...
            .delete_address .fa-remove , .delete_address ,.edit_address .fa-edit,.edit_address{
                position: static!important;
            }
        }
                        ...
                        <div class="page-content page-order">
                            ...
                            <form action="{{ url('review') }}" method="post">
                                ...
                                <div style="width:95%;margin:50px auto">
                                    ...
                                    <p><span class="icon_item_name"></span><span
                                                style="padding-right:5px;">انتخاب آدرس </span>
                                        <a class="my_button"
                                           onclick="show_address_form()" {{--href="{{route('site.addShipping')}}"--}}>
                                    ...
                                    @foreach($address as $key=>$value)
                                        ...
                                        @if($key==0)
                                            <input type="hidden" name="order_address" value="{{ $value->id }}"
                                                   id="order_address">
                                   ...
                                   <li class="icon-shopping-white-mark"></li>
                                                    ...
                                                    <span class="fa fa-remove"
                                                          onclick="del_row('<?= $value->id ?>','<?= url('shipping/remove_address') ?>','<?= Session::token() ?>')"></span>
                                                        </div>
                                                    </td>
                               ...
                               {{ $value->get_ostan->ostan_name }}
                                                    ...
                                                    <td rowspan="2">
                                                        <p>{{ $value->address }}</p>
                                                        <p><span>کد پستی : </span> <span>{{ $value->zip_code }}</span>
                                                        </p>
                                                    </td>
                                    ...
                                    <p style="padding-top:30px"><span class="icon_item_name"></span><span
                                                style="padding-right:5px;">زمان ارسال کالا </span></p>
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="float:right">
                                                     ...
                                                     <div style="float:right">
                                                           <p style="padding-right:15px">زمان تحويل:  {{$deliveryTime}} روز کاري درصورت  پرداخت
                                                            صورت حساب کالا تا
                                                            ساعت 12 (به‌جز روزهاي تعطيل)</p>
                                                </td>
                                        ...
                                        {{--<table class="user_address">
                                            ...
                                            <tr>
                                                <td class="first_td">
                                                    <div id="type_radio_2" class="type-radio-control"
                                                         onclick="set_type(2)">
                                                        <label></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <div style="float:right">
                                                        <p style="padding-right:15px;">باربري (پس کرايه | لوازم خانگي
                                                            سنگين)</p>
...
@section('bottom_script')
    ...
    $url2 = route('site.insertShipping');
    $url3 = route('site.shipping');
