                                ...
                                <div class="popup">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            ...
                                            <ul class="nav">
                                                @foreach($category->getChild as $childCategory)
                                                    @if($childCategory->id>=32&&$childCategory->id<=39)
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            ...
                                            <ul class="nav">
                                                @foreach($category->getChild as $childCategory)
                                                    @if($childCategory->id>=40&&$childCategory->id<=46)
                                        ...
                                        <div class="col-md-4 hidden-sm">
                                            ...
                                            <ul class="nav">
                                                @foreach($category->getChild as $childCategory)
                                                    @if($childCategory->id>=47&&$childCategory->id<=53)
                                        ...
                                        <div class="col-sm-12">
                                            <a class="ads1" href="#">
                                                <img class="img-responsive" src="{{asset('images/front-end/menu-img3.jpg')}}" alt="">
                                            </a>
                                        </div>
