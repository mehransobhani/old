    ...
    <ul>
        <li class="mt-root demo_custom_link_cms">
            <div class="mt-root-item"><a href="/">
                    <div class="title title_font"><span class="title-text">خانه</span></div>
                </a></div>
        ...
        <li class="mt-root">
            <div class="mt-root-item"><a href="{{route('site.listNews')}}">
                    <div class="title title_font"><span class="title-text">اخبار و مقالات</span></div>
                </a></div>
        </li>
        <li class="mt-root">
            <div class="mt-root-item"><a href="{{route('site.showPage',['projects'])}}">
                    <div class="title title_font"><span class="title-text">مشاوره و تجهیز</span></div>
                </a></div>
        </li>
        <li class="mt-root">
            <div class="mt-root-item"><a href="{{route('site.showPage',['works'])}}">
                    <div class="title title_font"><span class="title-text">تولید یخچال فروشگاهی</span></div>
                </a></div>
        </li>
        <li class="mt-root">
            <div class="mt-root-item"><a href="{{route('site.showPage',['about'])}}">
        ...
        <li class="mt-root">
            <div class="mt-root-item"><a href="#" style="cursor: none">
                        ...
                        <div class="item-inner">
                            <div class="product-thumbnail">
                                ...
                                <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                        <figure> <img class="first-img" src="images/front-end/products/img06.jpg" alt=""> <img class="hover-img" src="images/front-end/products/img06.jpg" alt=""></figure>
                                    </a>
                    ...
                    <div class="product-item">
                        <div class="item-inner">
                            <div class="product-thumbnail">
                                <div class="icon-sale-label sale-left">Sale</div>
                                <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                        <figure> <img class="first-img" src="images/front-end/products/img02.jpg" alt=""> <img class="hover-img" src="images/front-end/products/img02.jpg" alt=""></figure>
                                    </a>
                                    <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                                </div>
                                <div class="pr-info-area">
                    ...
                    <div class="product-item">
                        <div class="item-inner">
                            ...
                            <div class="product-thumbnail">
                                <div class="icon-sale-label sale-left">Sale</div>
                                <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="single_product.html">
                                        <figure> <img class="first-img" src="images/front-end/products/img03.jpg" alt=""> <img class="hover-img" src="images/front-end/products/img03.jpg" alt=""></figure>
                                    </a>
                                    <button type="button" class="add-to-cart-mt"> <i class="fa fa-shopping-cart"></i><span> Add to Cart</span> </button>
                                </div>
                                <div class="pr-info-area">
