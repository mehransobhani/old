                ...
                <tr>
                    <td class="item_first_td">
                        ...
                        @if($value->filed==1)
                            ...
                            <input type="checkbox" @if(get_active($filter_value,$value->id,$value2->id)) checked="checked"
                                   @endif  name="filter[<?= $value->id ?>][<?= $value2->id ?>]" value="<?= $value2->id ?>">
                            {{ $value2->name }}
                        @else
                            ...
                            @if(sizeof($e)==2)
                                <input type="checkbox"
                                       @if(get_active($filter_value,$value->id,$value2->id)) checked="checked"
                                       @endif name="filters[<?= $value->id ?>][<?= $value2->id ?>]"
                                       value="<?= $value2->id ?>">
                                {{ $e[0] }}
                            @endif
